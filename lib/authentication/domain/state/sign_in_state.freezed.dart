...
class _$_NotValid implements _NotValid {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _NotValid);
  }
...
abstract class _NotValid implements SignInState {
...
class _$_CanSubmit implements _CanSubmit {
  const _$_CanSubmit();
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _CanSubmit);
  }
...
abstract class _CanSubmit implements SignInState {
  const factory _CanSubmit() = _$_CanSubmit;
}
